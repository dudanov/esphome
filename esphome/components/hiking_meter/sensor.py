...
hiking_meter_ns = cg.esphome_ns.namespace("hiking_meter")
HikingMeter = hiking_meter_ns.class_(
    "HikingMeter", cg.PollingComponent, modbus.ModbusDevice
)
...
CONFIG_SCHEMA = (
    cv.Schema({cv.GenerateID(): cv.declare_id(HikingMeter)})
    .extend(
